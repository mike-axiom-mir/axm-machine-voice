...
from axm_machine_voice import FLOORVOICE, JOURNAL_PROTOCOL, SNAPSHOT_SCHEMA  # noqa: E402
...
class PortableContractTests(unittest.TestCase):
    ...
    def test_snapshot_schema_protocol_matches_runtime(self):
        schema = self.load("alternative-snapshot-0.1.schema.json")
        self.assertEqual(schema["properties"]["schema"]["const"], SNAPSHOT_SCHEMA)
        self.assertFalse(schema["additionalProperties"])
        self.assertGreaterEqual(schema["properties"]["required_constraints"]["minItems"], 1)
